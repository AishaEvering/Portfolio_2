...
const projects = [
  {
    ...
    modalContent: (
      <>
        ...
        <p>
          The live demo above features a custom React interface that
          communicates with my trained model for real-time inference through a
          containerized Flask API, hosted on Google Cloud.
        </p>
        <p>
