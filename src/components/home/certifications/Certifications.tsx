    ...
    description: (
      <>
        ...
        <p>
          ...
          effectively to real-world problems. If you&apos;d like to see the
          projects I&apos;ve completed on DataCamp, feel free to check out my
          <a
            target="_blank"
            rel="nofollow"
    ...
    description: (
      <>
        ...
        <p>
          ...
          professional settings. If you&apos;d like to see the projects
